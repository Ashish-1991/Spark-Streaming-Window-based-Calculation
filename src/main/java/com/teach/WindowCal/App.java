...
public class App implements Serializable
{
	public static JavaPairRDD<String,Integer> transformFunc(JavaRDD<String> lines)
	{
		...
		JavaPairRDD<String,Integer> wordcount = mappedWords.reduceByKey((a,b)->a+b);
		return wordcount;
	}
...
//(new Function<JavaRDD<String>,JavaPairRDD<String,Integer>> transformFunc()
//		 {
//
//			@Override
//			public JavaPairRDD<String, Integer> call(JavaRDD<String> v1)
//					throws Exception {
//				// TODO Auto-generated method stub
//				return null;
//			}
